...
class ConfPersonal1 extends StatefulWidget {
  final Future<Database> db;
  ConfPersonal1(this.db);

  @override
  State<StatefulWidget> createState() => _ConfPersonal1();
}

class _ConfPersonal1 extends State<ConfPersonal1> {
  final _prayNameList = [
    '2. 교회를 위한 기도',
    '3. 담임목사님을 위한 기도',
    '4. 목장과 목장원을 위한 기도',
