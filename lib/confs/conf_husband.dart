...
class ConfHusband extends StatefulWidget {
  final Future<Database> db;
  ConfHusband(this.db);

  @override
  State<StatefulWidget> createState() => _ConfHusband();
}

class _ConfHusband extends State<ConfHusband> {
  final _prayNameList = [
    '2. 교회를 위한 기도',
    '3. 담임목사님을 위한 기도',
    '4. 목장과 목장원을 위한 기도',
