...
class ConfParents extends StatefulWidget {
  final Future<Database> db;
  ConfParents(this.db);

  @override
  State<StatefulWidget> createState() => _ConfParents();
}

class _ConfParents extends State<ConfParents> {
  final _prayNameList = [
    '2. 교회를 위한 기도',
    '3. 담임목사님을 위한 기도',
    '4. 목장과 목장원을 위한 기도',
