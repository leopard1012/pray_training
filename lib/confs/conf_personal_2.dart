...
class ConfPersonal2 extends StatefulWidget {
  final Future<Database> db;
  ConfPersonal2(this.db);

  @override
  State<StatefulWidget> createState() => _ConfPersonal2();
}

class _ConfPersonal2 extends State<ConfPersonal2> {
  final _prayNameList = [
    '2. 교회를 위한 기도',
    '3. 담임목사님을 위한 기도',
    '4. 목장과 목장원을 위한 기도',
