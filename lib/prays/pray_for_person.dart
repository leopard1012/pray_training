...
class _PrayForPerson extends State<PrayForPerson> {
  ...
  Future<List<TextSpan>> getPray() async {
    ...
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue), recognizer: TapGestureRecognizer()..onTapDown = (p) => {Navigator.popAndPushNamed(context, '/conf/person')} ));
    textSpanList.add(TextSpan(text: ' 통하여 거룩히 여김 받으시기를 원합니다.\n'));
    ...
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 이루어지기를 원합니다.'));
    textSpanList.add(TextSpan(text: '그리하여'));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 심령에 의와 평강과 희락이 항상 있어 마음의 천국이 이루어지게 하옵소서.'));
    textSpanList.add(TextSpan(text: '그리고 '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 하나님의 통치를 받으며 하나님 나라의 법을 소중히 여기고 지키며 살게 하옵시고, 하나님 나라의 영광을 위하여 일하게 하옵소서.'));
    textSpanList.add(TextSpan(text: '그리고 '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 통하여 하나님 나라가 세상 모든 사람 전파되기를 원합니다.'));
    textSpanList.add(TextSpan(text: ''));
    ...
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 하나님의 뜻인 전도와 선과 의를 행하며 이웃에게 피해를 주지 않고 도움이 되는 삶을 살기를 기도합니다.'));
    textSpanList.add(TextSpan(text: '하나님의 뜻이 '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 통하여 온 땅에 전파되기를 원합니다.'));
    textSpanList.add(TextSpan(text: ''));
    textSpanList.add(TextSpan(text: '4) 하나님께서 '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 평생 동안 일용할 양식을 공급해 주시기를 원합니다.'));
    textSpanList.add(TextSpan(text: '또 세상에서 살아가는데 필요한 것을 공급하여 주시기를 원합니다.'));
    textSpanList.add(TextSpan(text: ' '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 하는 일들을 축복하여 주옵소서.'));
    ...
    textSpanList.add(TextSpan(text: ' '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 풍성한 물질을 주셔서 하나님을 위하여 언제나 즐거운 마음으로 풍성하게 드리게 하옵시며, 모범적으로 충성하고 헌신하는 사람이 되게 하옵소서.'));
    ...
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 주변 사람들이 모두 구원받기를 원합니다.'));
    textSpanList.add(TextSpan(text: '그들을 구우너하시어 하나님의 일꾼으로 사용하여 주옵소서.'));
    textSpanList.add(TextSpan(text: ''));
    textSpanList.add(TextSpan(text: '5) 하나님! 다른 사람의 죄를 용서합니다.'));
    textSpanList.add(TextSpan(text: '나에게 상처를 주고 힘들게 하였던 '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 용서합니다.'));
    textSpanList.add(TextSpan(text: accident, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 일로 나에게 상처를 주었습니다.'));
    textSpanList.add(TextSpan(text: '하지만 예수님의 말씀에 순종하여 용서합니다.'));
    textSpanList.add(TextSpan(text: '그리고 '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 축복합니다.'));
    textSpanList.add(TextSpan(text: ' '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 하나님을 경외하고 복 받기를 원합니다.'));
    textSpanList.add(TextSpan(text: ''));
    ...
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 시험에 들지 않기를 원합니다.'));
    ...
    textSpanList.add(TextSpan(text: ' '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 시험에 들지 않도록 지켜 주옵소서.'));
    textSpanList.add(TextSpan(text: ''));
    textSpanList.add(TextSpan(text: '8) 하나님! '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 를 악에서 구원하여 주옵소서.'));
    textSpanList.add(TextSpan(text: '우리에게는 악이 가득합니다.'));
    textSpanList.add(TextSpan(text: '사탄이 망므속에 악을 넣었습니다.'));
    ...
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 구원받기를 원합니다.'));
    textSpanList.add(TextSpan(text: '악을 주는 사탄의 세력을 쫓아 주옵소서.'));
    textSpanList.add(TextSpan(text: '그리고 악에서  '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 구원하여 교회로 인도하여 주옵소서.'));
    textSpanList.add(TextSpan(text: ' '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 세상의 악에 물들지 않도록 지켜 주옵소서.'));
    textSpanList.add(TextSpan(text: ' '));
    textSpanList.add(TextSpan(text: target, style: TextStyle(color: Colors.blue)));
    textSpanList.add(TextSpan(text: ' 연약하오니 하나님께서 악을 물리치고 이길 수 있는 힘을 공급하여 주옵소서.'));
    textSpanList.add(TextSpan(text: ''));
